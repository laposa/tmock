...
declare global {
  ...
  export type { Component, ComponentPublicInstance, ComputedRef, DirectiveBinding, ExtractDefaultPropTypes, ExtractPropTypes, ExtractPublicPropTypes, InjectionKey, MaybeRef, MaybeRefOrGetter, PropType, Ref, VNode, WritableComputedRef } from 'vue'
    ...
    // @ts-ignore
    export type { CreateUserPayload, UpdateProfilePayload, UpdateUserPayload } from './src/apis/useUsersApi'
    // @ts-ignore
    export type { SnackbarCatchErrorOpts } from './src/composables/useSnackbarWrapper'
    // @ts-ignore
    export type { SnackbarItem, SnackbarType } from './src/stores/snackbars.store'
    // @ts-ignore
